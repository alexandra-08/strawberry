...
use Strawberry\HelloBundle\Model\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'Strawberry\\HelloBundle\\Model\\User';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Gender', 'City', 'Active', 'TeamId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'gender', 'city', 'active', 'teamId', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::NAME, UserPeer::GENDER, UserPeer::CITY, UserPeer::ACTIVE, UserPeer::TEAM_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'GENDER', 'CITY', 'ACTIVE', 'TEAM_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'gender', 'city', 'active', 'team_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Gender' => 2, 'City' => 3, 'Active' => 4, 'TeamId' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'gender' => 2, 'city' => 3, 'active' => 4, 'teamId' => 5, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::NAME => 1, UserPeer::GENDER => 2, UserPeer::CITY => 3, UserPeer::ACTIVE => 4, UserPeer::TEAM_ID => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'GENDER' => 2, 'CITY' => 3, 'ACTIVE' => 4, 'TEAM_ID' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'gender' => 2, 'city' => 3, 'active' => 4, 'team_id' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::TEAM_ID);
        } else {
    ...
    public static function doCountJoinTeam(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UserPeer::TEAM_ID, TeamPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of User objects pre-filled with their Team objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinTeam(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (User) to $obj2 (Team)
                $obj2->addUser($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (User) to the collection in $obj2 (Team)
                $obj2->addUser($obj1);
