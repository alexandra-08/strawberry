...
namespace Strawberry\HelloBundle\Model\om;
...
use \PropelException;
use \PropelPDO;
use Strawberry\HelloBundle\Model\Team;
use Strawberry\HelloBundle\Model\TeamPeer;
use Strawberry\HelloBundle\Model\map\TeamTableMap;
...
abstract class BaseTeamPeer
{
    ...
    const OM_CLASS = 'Strawberry\\HelloBundle\\Model\\Team';
     ...
     * e.g. TeamPeer::$fieldNames[TeamPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'City', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'city', ),
        BasePeer::TYPE_COLNAME => array (TeamPeer::ID, TeamPeer::TITLE, TeamPeer::CITY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'CITY', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'city', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. TeamPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'City' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'city' => 2, ),
        BasePeer::TYPE_COLNAME => array (TeamPeer::ID => 0, TeamPeer::TITLE => 1, TeamPeer::CITY => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'CITY' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'city' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        $toNames = TeamPeer::getFieldNames($toType);
        $key = isset(TeamPeer::$fieldKeys[$fromType][$name]) ? TeamPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(TeamPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, TeamPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return TeamPeer::$fieldNames[$type];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TeamPeer::TITLE);
            $criteria->addSelectColumn(TeamPeer::CITY);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(TeamPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(TeamPeer::DATABASE_NAME);
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(TeamPeer::$instances[$key])) {
                return TeamPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (TeamPeer::$instances as $instance)
        {
          $instance->clearAllReferences(true);
        }
      }
        TeamPeer::$instances = array();
    }
    ...
    {
        $key = TeamPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = TeamPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + TeamPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = TeamPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Propel::getDatabaseMap(TeamPeer::DATABASE_NAME)->getTable(TeamPeer::TABLE_NAME);
    }
    ...
    /**
     * Performs an UPDATE on the database, given a Team or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(TeamPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(TeamPeer::ID);
            $value = $criteria->remove(TeamPeer::ID);
            if ($value) {
                $selectCriteria->add(TeamPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(TeamPeer::TABLE_NAME);
            }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(TeamPeer::TABLE_NAME, $con, TeamPeer::DATABASE_NAME);
