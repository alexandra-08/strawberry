...
use Strawberry\HelloBundle\Model\TeamQuery;
...
abstract class BaseUser extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Strawberry\\HelloBundle\\Model\\UserPeer';
    ...
    public function setTeamId($v)
    {
        ...
        if ($this->team_id !== $v) {
            $this->team_id = $v;
            $this->modifiedColumns[] = UserPeer::TEAM_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->gender = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserPeer::TEAM_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserPeer::TEAM_ID)) $criteria->add(UserPeer::TEAM_ID, $this->team_id);
     ...
     * @throws PropelException
     */
    public function getTeam(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTeam === null && ($this->team_id !== null) && $doQuery) {
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aTeam instanceof Persistent) {
              $this->aTeam->clearAllReferences($deep);
            }
