...
abstract class BaseTeam extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Strawberry\\HelloBundle\\Model\\TeamPeer';
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = TeamPeer::TITLE;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[] = TeamPeer::CITY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = TeamPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TeamPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(TeamPeer::CITY)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TeamPeer::TITLE)) $criteria->add(TeamPeer::TITLE, $this->title);
        if ($this->isColumnModified(TeamPeer::CITY)) $criteria->add(TeamPeer::CITY, $this->city);
