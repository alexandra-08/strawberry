...
class TeamTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Strawberry.HelloBundle.Model.map.TeamTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Strawberry\\HelloBundle\\Model\\Team');
    ...
    {
        $this->addRelation('User', 'Strawberry\\HelloBundle\\Model\\User', RelationMap::ONE_TO_MANY, array('id' => 'team_id', ), null, null, 'Users');
    } // buildRelations()
